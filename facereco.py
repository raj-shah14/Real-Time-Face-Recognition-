...
if video_mode:
    ...
    while True:
        ...
        # Find all the faces and face encodings in the current frame of video
            ...
            face_landmarks_list2 = face_recognition.face_landmarks(rgb_frame)
        ...
        for (top, right, bottom, left), name in zip(face_locations, face_names):
            ...
            cv2.putText(rgb_frame, name, (left + 6, bottom + 25), font, 1.0, (255, 255, 255), 1)
